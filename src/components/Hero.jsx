              ...
              {/* //////////hero section/////////// */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[850px]">
                  ...
                  <div className='relative'>
                    <motion.img initial={{opacity:0, Scale:0}} animate={{opacity:1,Scale:1}} transition={{type:'spring',stiffness:'100',damping:10,delay:0.4}} src="./black.png" alt=""  className='relative h-[400px] z-40 md:h-[700px] img-shadow'/>
                    {/* /////////circle//////////// */}
